    ...
    try {
      const inboxGmail = `<div
        ...
        <div
            ...
            <h3>Welcome to My Apikey Adbanboot!</h3>
            <p>
...
If you have any problem, please contact via <span
                    style="color: #4D96FF;"><a href="https://api.whatsapp.com/send?phone=6283198177108">WhatsApp</a></span></span>
            <span style="display: block;"><br>By,<br>Adnanboot</span>
        </div>
    </div>
      `;
      ...
      let mailOptions = {
        from: '"Adnanboot" <no-reply@gmail.com>',
        to: email,
        subject: `Verify Email - Apikeyadnanboot`,
        html: inboxGmail,
      };
